...
namespace te
{
	namespace core
	{
		...
		EDeviceType tePlatform_iOS::DefinePlatform()
		{
			...
			if(strstr(machine, "iPhone2,1")) return DT_IOS_IPHONE_3GS;
			if(strstr(machine, "iPhone3,1")) return DT_IOS_IPHONE_4;
			if(strstr(machine, "iPhone3,3")) return DT_IOS_IPHONE_4;
			if(strstr(machine, "iPhone4,1")) return DT_IOS_IPHONE_4S;
